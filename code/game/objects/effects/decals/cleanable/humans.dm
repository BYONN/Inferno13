...
/obj/effect/decal/cleanable/urine
	name = "urine"
	desc = "Someone's leaked all over the place."
	gender = PLURAL
	density = 0
	layer = ABOVE_NORMAL_TURF_LAYER
...
/obj/effect/decal/cleanable/urine/Initialize(mapload, list/datum/disease/diseases)
	. = ..()
	reagents.add_reagent(/datum/reagent/consumable/urine, 10)
