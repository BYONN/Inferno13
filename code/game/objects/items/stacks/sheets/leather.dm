...
/obj/item/stack/sheet/animalhide/chud
	name = "chud skin"
	desc = "Thick, leathery skin from a sewerdwelling chud. Yuck."
	icon_state = "sheet-chudskin"
	singular_name = "chud skin patch"
	novariants = FALSE
	merge_type = /obj/item/stack/sheet/animalhide/chud
	obj_value = 15
