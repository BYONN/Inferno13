...
/obj/item/pda
	name = "wristpad"
	desc = "A thick wristwatch with an integrated keyboard, speaker, and mini-LCD.  A Catharsis City credit chip is attached to the left side of the watch, with a few wires leading into your bare skin.  You've had it your whole life, so you never really noticed until just now how disturbing and occasionally itchy that is."
	icon = 'icons/obj/pda.dmi'
	icon_state = "pda"
	item_state = "wristpad"
	item_flags = NOBLUDGEON | NO_UNIFORM_REQUIRED
	w_class = WEIGHT_CLASS_NORMAL
	slot_flags = ITEM_SLOT_ID | ITEM_SLOT_GLOVES | ITEM_SLOT_BELT
...
/obj/item/pda/attackby(obj/item/C, mob/user, params)
	...
	if(istype(C, /obj/item/holochip) && id)
