...
/obj/structure/lattice/catwalk/bridge
	name = "wooden bridge"
	desc = "A bridge made of wooden planks. It can probably handle your weight."
	icon = 'icons/obj/smooth_structures/wood_bridge.dmi'
	icon_state = "wood_bridge"

/obj/structure/lattice/catwalk/bridge/deconstruction_hints(mob/user)
	return