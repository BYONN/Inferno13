...
/datum/preferences/proc/ShowChoices(mob/user)
	...
	switch(current_tab)
		if (0) // Character Settings#
			...
			dat += "<a href='?_src_=prefs;preference=skills;task=menu'>View Skills</a><br></center>"
...
/datum/preferences/proc/ShowSkills(mob/user)
	...
	for (var/skill in skills)
		dat += "<b>[skill]	   :</b> [skills[skill]]</a><BR>"
	dat += "<center><a href='?_src_=prefs;preference=skills;task=close'>Close</a></center>"

	user << browse(null, "window=preferences")
	var/datum/browser/popup = new(user, "mob_occupation", "<div align='center'>Skills</div>", 300, 400)
	popup.set_window_options("can_close=0")
	popup.set_content(dat.Join())
	popup.open(0)
	return
