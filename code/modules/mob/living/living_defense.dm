...
/mob/living/proc/run_armor_check(def_zone = null, attack_flag = "beat", absorb_text = "Your armor absorbs the blow!", soften_text = "Your armor softens the blow!", armour_penetration, penetrated_text = "Your armor was penetrated!", silent=FALSE, attack_damage)
	...
	if(I)
		...
		if(!blocked)
			if(!nosell_hit)
				...
				if(!I.throwforce)
					return
				var/armor = run_armor_check(impacting_zone, I.damtype, "Your armor has protected your [parse_zone(impacting_zone)].", "Your armor has softened hit to your [parse_zone(impacting_zone)].",I.armour_penetration)
