...
/mob/living/simple_animal/hostile/mirelurk/hunter
	...
	icon_gib = "gib"
	guaranteed_butcher_results = list(/obj/item/reagent_containers/food/snacks/meat/slab/lobstrosity = 4, /obj/item/stack/sheet/sinew = 2)
	maxHealth = 250
	health = 250
...
/mob/living/simple_animal/hostile/mirelurk/baby
	...
	icon_state = "lobstrositybaby"
	icon_living = "lobstrositybaby"
	icon_dead = "lobstrositybaby_d"
	icon_gib = "gib"
	guaranteed_butcher_results = list(/obj/item/reagent_containers/food/snacks/meat/slab/lobstrosity = 1)
	speed = 1
	maxHealth = 50
	health = 50
	melee_damage_lower = 5
