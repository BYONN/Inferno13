/mob/living/simple_animal
	...
	var/icon_gib = null
	///Overlay for weapons while the mob is alive.
	var/weapon_overlay = null
	...
	var/list/loot = list()
	//list of things that can be gotten by intentionally rifling through the mob
	var/list/deep_loot = list()
	//money that can be looted along with deep loot
	var/cash_loot_min = 0
	var/cash_loot_max = 0
