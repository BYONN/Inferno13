...
/obj/item/reagent_containers/food/snacks/meat/slab/chud
	name = "chud meat"
	desc = "A slab of filthy raw chud meat."
	icon_state = "chudmeat"
	bitesize = 3
	list_reagents = list(/datum/reagent/consumable/nutriment = 1, /datum/reagent/toxin = 1)
	filling_color = "#99C76D"
	cooked_type = /obj/item/reagent_containers/food/snacks/meat/steak/chud
	slice_path = /obj/item/reagent_containers/food/snacks/meat/rawcutlet/chud
...
/obj/item/reagent_containers/food/snacks/meat/steak/chud
	name = "chud steak"
	tastes = list("sewers" = 1)
...
/obj/item/reagent_containers/food/snacks/meat/rawcutlet/chud
	name = "raw chud cutlet"
	cooked_type = /obj/item/reagent_containers/food/snacks/meat/cutlet/chud
	tastes = list("sewers" = 1)
...
/obj/item/reagent_containers/food/snacks/meat/cutlet/chud
	name = "chud cutlet"
	tastes = list("sewers" = 1)
