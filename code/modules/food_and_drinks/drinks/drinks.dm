...
/obj/item/reagent_containers/food/drinks/flask/canteen
	name = "canteen"
	desc = "A built-to-last plastic canteen."
	icon_state = "canteen"
	volume = 120
	custom_materials = list(/datum/material/plastic=550)

/obj/item/reagent_containers/food/drinks/flask/canteen/gray
	icon_state = "canteen_gray"

/obj/item/reagent_containers/food/drinks/flask/canteen/piss
	icon_state = "canteen_piss"
