...
/datum/reagent/consumable/urine
	name = "Urine"
	description = "A liquid waste product from an animal."
	taste_description = "salty bitterness"
	taste_mult = 3
	data = list("donor"=null,"viruses"=null,"donor_DNA"=null,"blood_type"=null,"resistances"=null,"trace_chem"=null)
	reagent_state = LIQUID
	color = "#FFE464"
	can_synth = FALSE
	nutriment_factor = 0.5 * REAGENTS_METABOLISM
	water_factor = 0.2 * REAGENTS_METABOLISM
...
/datum/reagent/consumable/urine/reaction_turf(turf/T, reac_volume)
	...
	var/obj/effect/decal/cleanable/urine/U = locate() in T
	if(!U)
		U = new decal_path(T)
	if(data["blood_DNA"])
