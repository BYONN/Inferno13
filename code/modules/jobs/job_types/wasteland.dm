...
/datum/job/wasteland/infernoclone
	title = "Clone"
	flag = INFERNOCLONE
	faction = "Wastelander"
	total_positions = -1
	spawn_positions = -1
	description = "Life, death, rebirth. This is your incessant cycle, as long as your credit chip balance can assure your next reincarnation."
	supervisors = "no one"
	selection_color = "#dddddd"
	outfit = /datum/outfit/job/wasteland/infernoclone
	access = list()
	minimal_access = list()

/datum/outfit/job/wasteland/infernoclone
	name = "Clone"
	jobtype = /datum/job/wasteland/infernoclone
	uniform = null
	shoes = null
	id = /obj/item/card/id
	ears = null
