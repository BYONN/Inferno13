...
/obj/item/projectile
	...
	var/flag = "shot" //Defines what armor to use when it hits things.
	...
	var/no_friendly_fire = FALSE //Checks faction on target and firer. Mainly for NPCs.
	var/list/faction = list() //Don't gat your homies
