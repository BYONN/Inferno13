...
/obj/item/reagent_containers/food/snacks/meat/slab/lobstrosity
	name = "lobstrosity meat"
	desc = "Meat from a lobstrosity, still inside its shell.  Going to need pliers for this..."
	icon = 'icons/fallout/objects/food&drinks/food.dmi'
	icon_state = "lobstrosity_meat"
	...
	cooked_type = /obj/item/reagent_containers/food/snacks/meat/steak/lobstrosity
	tastes = list("crab" = 1)
	slice_path = null
	foodtype = RAW | MEAT
...
/obj/item/reagent_containers/food/snacks/meat/steak/lobstrosity
	name = "lobstrosity roast"
	desc = "Meat from a lobstrosity's shell, cracked open and roasted to perfection."
	icon = 'icons/fallout/objects/food&drinks/food.dmi'
	icon_state = "lobstrosity_roast"
	list_reagents = list(/datum/reagent/consumable/nutriment = 5)
...
/obj/item/reagent_containers/food/snacks/f13/lobstrositycake
	name = "lobstrosity cake"
	desc = "A savory cake made from the meat of a lobstrosity.  A popular dish from the coastlines."
	bitesize = 5
	icon_state = "lobstrosity_cake"
...
/obj/item/reagent_containers/food/snacks/soup/lobstrositystew
	name = "lobstrosity stew"
	desc = "A hearty stew made from de-shelled lobstrosity meat, onions, butter, and other such delights."
	icon = 'icons/fallout/objects/food&drinks/soupsalad.dmi'
	icon_state = "lobstrosity_stew"
	bitesize = 6
	volume = 50
	list_reagents = list(/datum/reagent/consumable/nutriment = 20)
