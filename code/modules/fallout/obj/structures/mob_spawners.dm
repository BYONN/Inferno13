...
/obj/structure/nest/lobstrosity
	name = "lobstrosity nest"
	max_mobs = 1
	mob_types = list(/mob/living/simple_animal/hostile/lobstrosity = 1)
...
/obj/structure/nest/clone
	...
	icon_state = "pod_1"
	max_mobs = 1
	mob_types = list(/mob/living/simple_animal/hostile/retaliate/clone = 1,
					/mob/living/simple_animal/hostile/retaliate/clone/female = 1)
	spawn_time = 20 SECONDS
