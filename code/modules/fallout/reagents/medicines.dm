...
/datum/reagent/medicine/nanite/reaction_mob(mob/living/M, method=TOUCH, reac_volume, show_message = 1)
...
/datum/reagent/medicine/nanite/on_mob_life(mob/living/carbon/M)
...
/datum/reagent/medicine/nanite/overdose_process(mob/living/M)
