...
#define NOEYES			17
#define MARKINGS		18
#define MUTCOLORS2		19
#define MUTCOLORS3		20
#define NOAROUSAL		21	//Stops all arousal effects
#define NOGENITALS		22	//Cannot create, use, or otherwise have genitals
#define MATRIXED		23	//if icon is color matrix'd
#define SKINTONE		24	//uses skin tones
#define CUSTOM_SKINTONE	25	//adds a "_g" suffix to bodypart overlays icon states if a custom skintone is used.
#define HORNCOLOR		26
#define WINGCOLOR		27
#define ROBOTIC_LIMBS	28 //has robotic limbs that render like organic ones
#define CAN_SCAR		29 // If this species can be scarred (fleshy)
/// Used for determining which wounds are applicable to this species.
#define HAS_FLESH	30 /// if we have flesh (can suffer slash/piercing/burn wounds, requires they don't have NOBLOOD)
#define HAS_BONE	31 /// if we have bones (can suffer bone wounds)
